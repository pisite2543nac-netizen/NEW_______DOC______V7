...
assert any(x in meta for x in ['RELEASE_VERSION="V20.1"','RELEASE_VERSION="V20.2"','RELEASE_VERSION="V20.3"','RELEASE_VERSION="V20.4"','RELEASE_VERSION="V20.5"','RELEASE_VERSION="V20.6"'])
...
assert ver['version'] in ['20.1','20.2','20.3','20.4','20.5','20.6']
