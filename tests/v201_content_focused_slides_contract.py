...
assert any(x in idx for x in ['data-docnr-release="v20-1-content-focused-slides"','data-docnr-release="v20-2-adaptive-mobile-camera-stability"','data-docnr-release="v20-3-device-adaptive-interaction-camera-stability"','data-docnr-release="v20-4-real-device-mobile-router-adaptive-camera"'])
assert any(x in meta for x in ['RELEASE_VERSION="V20.1"','RELEASE_VERSION="V20.2"','RELEASE_VERSION="V20.3"','RELEASE_VERSION="V20.4"'])
assert any(x in sw for x in ['doc-full-nr-v20-1-content-focused-slides-20260922','doc-full-nr-v20-2-adaptive-mobile-camera-stability-20260922','doc-full-nr-v20-3-device-adaptive-interaction-camera-stability-20260922','doc-full-nr-v20-4-real-device-mobile-router-adaptive-camera-20260923'])
...
assert ver['version'] in ['20.1','20.2','20.3','20.4']
