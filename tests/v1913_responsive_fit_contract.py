...
assert ('data-docnr-release="v21-0-major-stability-unified-runtime"' in index) or ('data-docnr-release="v21-1-mobile-essentials-reliable-back"' in index) or ('data-docnr-release="v21-2-cross-device-stable"' in index)
assert (('v21-core-ui.css?v=20260924-v21-0' in index) or ('v21-core-ui.css?v=20260925-v21-1' in index) or ('v21-core-ui.css?v=20260925-v21-2' in index)) and index.index('v21-core-ui.css')>index.index('v16-8-course-flow.css')
