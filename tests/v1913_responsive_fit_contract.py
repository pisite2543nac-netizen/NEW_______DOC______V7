...
checks={
  'fit css loaded last':'v19-responsive-fit.css?v=20260916-v19-1-3' in index and index.index('v19-responsive-fit.css')>index.index('v16-8-course-flow.css'),
  ...
  'service worker cache':'v19-responsive-fit.css?v=20260916-v19-1-3' in sw and 'doc-full-nr-v19-1-3-responsive-fit-20260916' in sw,
}
failed=[k for k,v in checks.items() if not v]
if failed: raise SystemExit('V19.1.3 RESPONSIVE FIT CONTRACT FAIL: '+', '.join(failed))
for k in checks: print(k+': PASS')
print('V19.1.3 RESPONSIVE FIT CONTRACT PASS')
