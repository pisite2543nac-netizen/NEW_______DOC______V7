...
ok('v16-integrated-final' in index,'index missing V16 release marker')
...
ok('doc-full-nr-v16-final-20260911' in sw,'service worker cache marker is not V16')
platform=(SITE/'v16-platform.js').read_text('utf-8')
ok('V16-INTEGRATED-ROOMS-GRADEBOOK-SCAN-REALTIME' in platform,'V16 platform marker missing')
...
print('release=V16 FINAL; files=',len(required),'manifest_icons=',len(icons))
