...
ok('v16-5-course-code-birthdate' in index,'index missing V16.5 release marker')
...
ok('doc-full-nr-v16-5-course-code-20260911' in sw,'service worker cache marker is not V16.5')
...
ok('V16.5-COURSE-CODE-BIRTHDATE-HALF-CREDIT' in platform,'V16.5 platform marker missing')
...
print('release=V16.5 FINAL; files=',len(required),'manifest_icons=',len(icons))
