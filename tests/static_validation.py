...
ok('v16-2-grade-report' in index,'index missing V16.2 release marker')
...
ok('doc-full-nr-v16-2-grade-report-20260911' in sw,'service worker cache marker is not V16.2')
platform=(SITE/'v16-platform.js').read_text('utf-8')
ok('V16.2-GRADE-REPORT-WEB-DETAIL' in platform,'V16.2 platform marker missing')
...
print('release=V16.2 FINAL; files=',len(required),'manifest_icons=',len(icons))
