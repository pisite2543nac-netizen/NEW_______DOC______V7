...
ok('v16-4-thai-filters-profile' in index,'index missing V16.4 release marker')
...
ok('doc-full-nr-v16-4-thai-profile-20260911' in sw,'service worker cache marker is not V16.4')
...
ok('V16.4-THAI-REG-FILTERS-PROFILE-ANALYTICS' in platform,'V16.4 platform marker missing')
...
print('release=V16.4 FINAL; files=',len(required),'manifest_icons=',len(icons))
