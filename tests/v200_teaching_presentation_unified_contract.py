...
assert ('data-docnr-release="v20-0-teaching-presentation-unified"' in idx) or (('data-docnr-release="v20-1-content-focused-slides"' in idx) or ('data-docnr-release="v20-2-adaptive-mobile-camera-stability"' in idx) or ('data-docnr-release="v20-3-device-adaptive-interaction-camera-stability"' in idx) or (('data-docnr-release="v20-4-real-device-mobile-router-adaptive-camera"' in idx) or ('data-docnr-release="v20-5-late-teacher-barcode-admin-room-groups"','data-docnr-release="v20-6-adaptive-stability-teacher-room-integration"' in idx)))
assert any(x in idx for x in ['v20-unified-ui.css?v=20260922-v20-0','v20-unified-ui.css?v=20260922-v20-1','v20-unified-ui.css?v=20260922-v20-2','v20-unified-ui.css?v=20260922-v20-3','v20-unified-ui.css?v=20260923-v20-4','v20-unified-ui.css?v=20260923-v20-5','v20-unified-ui.css?v=20260924-v20-6','v20-unified-ui.css?v=20260924-v20-7']) and idx.index('v20-unified-ui.css')>idx.index('v19-programming-activity.css')
