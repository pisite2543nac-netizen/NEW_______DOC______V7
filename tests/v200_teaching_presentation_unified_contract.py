...
assert ('data-docnr-release="v21-1-mobile-essentials-reliable-back"' in idx) or ('data-docnr-release="v21-0-major-stability-unified-runtime"' in idx) or ('data-docnr-release="v20-0-teaching-presentation-unified"' in idx) or (('data-docnr-release="v20-1-content-focused-slides"' in idx) or ('data-docnr-release="v20-2-adaptive-mobile-camera-stability"' in idx) or ('data-docnr-release="v20-3-device-adaptive-interaction-camera-stability"' in idx) or (('data-docnr-release="v20-4-real-device-mobile-router-adaptive-camera"' in idx) or ('data-docnr-release="v20-5-late-teacher-barcode-admin-room-groups"','data-docnr-release="v20-6-adaptive-stability-teacher-room-integration"' in idx)))
