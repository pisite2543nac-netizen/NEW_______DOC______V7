...
assert any(x in sw for x in ['./device-camera-runtime.js?v=20260923-v20-5','./device-camera-runtime.js?v=20260924-v20-6'])
...
assert float(version['version'])>=20.5 and version['release_marker'] in {'V20.5','V20.6'}
