...
assert 'data-docnr-release="v20-5-late-teacher-barcode-admin-room-groups"' in index
assert index.index('device-camera-runtime.js') < index.index('app.js') < index.index('v16-platform.js')
assert 'doc-full-nr-v20-5-late-teacher-barcode-admin-room-groups' in sw
assert './device-camera-runtime.js?v=20260923-v20-5' in sw
assert 'RELEASE_VERSION="V20.5"' in meta and '20260923-v20-5' in meta
assert version['version']=='20.5' and version['release_marker']=='V20.5'
