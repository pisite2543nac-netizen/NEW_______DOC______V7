...
assert any(x in index for x in ['v19-9-detailed-teaching-slides','v20-0-teaching-presentation-unified','v20-1-content-focused-slides','v20-2-adaptive-mobile-camera-stability'])
