...
assert 'v19-9-detailed-teaching-slides' in index
...
assert 'วิธีวิเคราะห์อย่างเป็นระบบ' in flow
...
assert ver['version']=='19.9' and ver['teaching_slides']['detailed_explanations'] is True
