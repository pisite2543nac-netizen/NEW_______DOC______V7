...
assert 'data-docnr-release="v20-6-adaptive-stability-teacher-room-integration"' in idx
assert 'v20-stability.css?v=20260924-v20-6' in idx and 'v20-stability-runtime.js?v=20260924-v20-6' in idx
assert idx.index('v20-stability.css') > idx.index('v20-unified-ui.css')
assert 'RELEASE_VERSION="V20.6"' in meta and ver['version']=='20.6' and ver['release_marker']=='V20.6'
...
for m in ['.docnr-sidebar-backdrop{pointer-events:none!important','.docnr-sidebar-backdrop.open{pointer-events:auto!important','max-height:calc(100dvh','html.docnr-tablet','html.docnr-phone','overflow-x:clip','touch-action:manipulation']:
    assert m in css,m
assert 'doc-full-nr-v20-6-adaptive-stability-teacher-room-integration-20260924' in sw
assert './v20-stability.css?v=20260924-v20-6' in sw and './v20-stability-runtime.js?v=20260924-v20-6' in sw
