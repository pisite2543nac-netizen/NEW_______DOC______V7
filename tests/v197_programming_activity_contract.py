...
assert any(x in index for x in ['v19-programming-activity.css?v=20260921-v19-8','v19-programming-activity.css?v=20260922-v19-9','v19-programming-activity.css?v=20260922-v20-0','v19-programming-activity.css?v=20260922-v20-1','v19-programming-activity.css?v=20260922-v20-2'])
assert any(x in index for x in ['v19-programming-activity.js?v=20260921-v19-8','v19-programming-activity.js?v=20260922-v19-9','v19-programming-activity.js?v=20260922-v20-0','v19-programming-activity.js?v=20260922-v20-1','v19-programming-activity.js?v=20260922-v20-2'])
...
assert any(x in sw for x in ['./v19-programming-activity.js?v=20260921-v19-8','./v19-programming-activity.js?v=20260922-v19-9','./v19-programming-activity.js?v=20260922-v20-0','./v19-programming-activity.js?v=20260922-v20-1','./v19-programming-activity.js?v=20260922-v20-2'])
