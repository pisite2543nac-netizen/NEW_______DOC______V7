# Nangrong Smart Worksheet System / DOC-FULL-NR — V16.6 STABLE FULL SYSTEM
...
- ถ้าพิมพ์ตัวอักษรอังกฤษในช่องชื่อ/ชื่อเล่น ระบบแจ้งให้กรอกชื่อและชื่อเล่นเป็นภาษาไทยเท่านั้น และลบตัวอักษรอังกฤษ
...
## V16.6 System Stabilization
- ลบ dependency `v15-tech.css` ที่ไม่มีไฟล์จริงและทำให้บาง client เกิด 404
- แก้ Card Navigation ไม่ให้ MutationObserver ทำลาย icon/label หลัง rerender
- Admin สร้างนักศึกษาได้ครบ: ชื่อจริง ชื่อเล่น วันเกิด รหัส ชั้น ห้อง แผนก สาขา เบอร์โทร เลขที่ และรหัสผ่าน
- Admin แก้ข้อมูลนักศึกษาได้ และเมื่อแก้รหัสนักศึกษา Backend จะ sync Login/Auth email ให้ตรงกัน
- Backend `admin-create-user` v10 และ `admin-operations` v13 เป็นรุ่นใช้งาน Production
- ระบบสอบบังคับ Server Time และไม่รับคำตอบใหม่หลังหมดเวลา; ใช้ autosave ล่าสุดก่อนหมดเวลา
- คง 198 ready-made worksheets, join-code 11 รายวิชา, Attendance Realtime, Gradebook 40+20+20+20 และย้อนหลัง 50%


## V16.6 Final deployment gate
