...
// DOC-FULL-NR V20.3 device-adaptive mobile interaction / camera stability cache marker
...
const CACHE="doc-full-nr-v20-3-device-adaptive-interaction-camera-stability-20260922";
const SHELL=[
  "./","./index.html","./exam.html",
  "./styles.css?v=20260922-v20-3","./mobile.css?v=20260922-v20-3","./v18-core-ui.css?v=20260922-v20-3","./v16-minimal.css?v=20260922-v20-3",
  "./v16-7-hardening.css?v=20260922-v20-3","./v16-8-course-flow.css?v=20260922-v20-3","./v19-responsive-fit.css?v=20260922-v20-3","./v19-production-ui.css?v=20260922-v20-3","./v19-print-system.css?v=20260922-v20-3","./v19-programming-activity.css?v=20260922-v20-3","./v20-unified-ui.css?v=20260922-v20-3","./v18-7-exam-adapted.css?v=20260922-v20-3",
  "./device-camera-runtime.js?v=20260922-v20-3","./camera-registration.js?v=20260922-v20-3","./app.js?v=20260922-v20-3","./mobile.js?v=20260922-v20-3","./v16-platform.js?v=20260922-v20-3",
  "./v16-7-hardening.js?v=20260922-v20-3","./v16-8-course-flow.js?v=20260922-v20-3","./v16-exam.js?v=20260922-v20-3","./v19-programming-activity.js?v=20260922-v20-3","./v19-ux-runtime.js?v=20260922-v20-3",
  "./manifest.webmanifest?v=20260922-v20-3","./release-meta.js","./data/teaching-knowledge-v20.js","./data/programming-activity-v197.json","./data/exam-question-bank-v18.json","./data/exam-question-bank-manifest-v18.json",
