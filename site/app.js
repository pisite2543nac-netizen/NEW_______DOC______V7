...
const isTeacher=()=>S.profile?.role==="teacher";
...
const ROUTE_TITLES={
  dashboard:"หน้าแรก",courses:"การสอนและรายวิชา",teacherwork:"ตรวจงาน",students:"นักศึกษาและสิทธิ์",roomgroups:"จัดกลุ่มห้องโดย Admin",workadmin:"งาน คะแนน และรายงาน",workcheck:"ตารางเช็กรวมการเก็บงานรายห้อง",printcenter:"ศูนย์พิมพ์และสรุปผล",paperscan:"สแกนใบงานย้อนหลัง",attendancehub:"เช็คชื่อและห้องเรียน",exam:"ระบบสอบ",specialactivity:"กิจกรรมพิเศษ",academic:"ปีการศึกษาและระบบ",
...
const FEATURE_ROUTES=new Set(["dashboard","courses","teacherwork","students","workadmin","workcheck","printcenter","paperscan","attendancehub","academic","catalog","work","attendance","accounts","enrollments","profiles","roomgroups","presence","promotion","history","enroll"]);
...
function fallbackBackTarget(){
  ...
  if(isStaff()&&S.route==="attendance")return {route:"attendancehub",arg:null};
...
async function routeCurrent(expectedSerial=S.navSerial){
  ...
  try{
    ...
    if(route==="exam"){
      ...
      try{sessionStorage.setItem("docnr-return-route",JSON.stringify({route:isStaff()?"courses":"dashboard",arg:arg||null}))}catch{}
...
// V20.4 regression compatibility marker: if(isAdmin()&&route==="attendance")return "attendancehub"
// V20.4 regression compatibility marker: if(isAdmin()&&S.route==="attendance")return {route:"attendancehub",arg:null}
