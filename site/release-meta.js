...
export const RELEASE_VERSION="V20.5";
export const RELEASE_NAME="V20.5 LATE TEACHER BARCODE • ADMIN ROOM GROUPS • STABLE MOBILE";
export const RELEASE_DATE="2026-09-23";
export const RELEASE_CACHE="20260923-v20-5";
