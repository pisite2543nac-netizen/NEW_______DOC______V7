...
export const RELEASE_VERSION="V20.3";
export const RELEASE_NAME="V20.3 DEVICE ADAPTIVE UX • MOBILE INTERACTION & CAMERA STABILITY";
export const RELEASE_DATE="2026-09-22";
export const RELEASE_CACHE="20260922-v20-3";
